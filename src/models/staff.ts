...
export type StaffData = Omit<Staff, "_id" | "createdAt" | "updatedAt" | "checkin" | "prepDone">;
...
export async function insertStaff(data: StaffData): Promise<Staff> {
  ...
  return { ...data, checkin: null, prepDone: [], _id: insertedId.toString(), createdAt: now, updatedAt: now };
}
