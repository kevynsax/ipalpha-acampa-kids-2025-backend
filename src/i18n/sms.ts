...
const pt: Catalog = {
  ...
  roleBusHelper: "ajudante do ônibus",
  roleBusHelperNamed: "ajudante do {vehicle}",
...
const en: Catalog = {
  ...
  roleBusHelper: "bus helper",
  roleBusHelperNamed: "{vehicle} helper",
...
const es: Catalog = {
  ...
  roleBusHelper: "ayudante del autobús",
  roleBusHelperNamed: "ayudante del {vehicle}",
...
const fr: Catalog = {
  ...
  roleBusHelper: "aide du bus",
  roleBusHelperNamed: "aide du {vehicle}",
